        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: size.height * 0.025),
              MyTextField(hintText: 'Profession', obsecure: false, icon: const Icon(Icons.art_track_sharp, size: 20), controller: professionController),
              SizedBox(height: size.height * 0.035),
               state? const CircularProgressIndicator(): MyButton(
                onPressed: () {  
                  check();
                },
